...
Source0  : https://files.pythonhosted.org/packages/ad/28/bacd3aa2394d8afab892d51098992f64ff14a10575ec0de44aa93aba9a72/sphinx-last-updated-by-git-0.3.3.tar.gz
...
%prep
%setup -q -n sphinx-last-updated-by-git-0.3.3
cd %{_builddir}/sphinx-last-updated-by-git-0.3.3
pushd ..
cp -a sphinx-last-updated-by-git-0.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661193881

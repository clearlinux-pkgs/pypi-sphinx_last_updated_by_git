...
Source0  : https://files.pythonhosted.org/packages/7c/19/73a2d88e9aa8d89c9961905cdd0dfcd48f8efaee47228a2446d5436960a2/sphinx-last-updated-by-git-0.3.4.tar.gz
...
%prep
%setup -q -n sphinx-last-updated-by-git-0.3.4
cd %{_builddir}/sphinx-last-updated-by-git-0.3.4
pushd ..
cp -a sphinx-last-updated-by-git-0.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662136782
